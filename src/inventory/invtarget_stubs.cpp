// invtarget_stubs.cpp - Stub implementations for INVTarget class methods
...
// ======================================================================
// Additional INVTarget stubs (gap fill)
// ======================================================================
...
// 0x8032C50C | 312 bytes
void INVTarget::SetAllObjectRelatedCheatStrings(InteractorModule::WallData *) {
}

// 0x8032C644 | 188 bytes
void INVTarget::SetAllObjectRelatedCheatStrings(InteractorModule::WallPaperData *) {
}

// 0x8032C700 | 188 bytes
void INVTarget::SetAllObjectRelatedCheatStrings(InteractorModule::FloorData *) {
}
...
// 0x8032D09C | 208 bytes
void INVTarget::CommittChangesToInventory(InteractorModule::WallPainter::CallbackData *) {
}
...
// 0x80333418 | 244 bytes
void INVTarget::PrepareObjectInfo(InteractorModule::WallPaperData *, int, bool) {
}

// 0x8033350C | 244 bytes
void INVTarget::PrepareObjectInfo(InteractorModule::FloorData *, int, bool) {
}

// 0x80333600 | 264 bytes
void INVTarget::PrepareObjectInfo(InteractorModule::WallData *, int, bool) {
}
...
// 0x80333AC8 | 104 bytes
void INVTarget::GetMotiveText(int, unsigned wchar_t *) {
}

// 0x80333B30 | 512 bytes
void INVTarget::GetMotiveText(BBI::InventoryItem *, unsigned wchar_t *) {
}

// 0x80333D30 | 336 bytes
void INVTarget::GetMotiveText(int, InteractorModule::ShoppingItem *, unsigned wchar_t *) {
}
