// interactor_stubs.cpp - Stub implementations for InteractorModule class methods
// Auto-generated from symbols.json - 321 functions
...
// 0x8031CF5C | 52 bytes
InteractorModule::FloorPainter::FloorPainterParams::~FloorPainterParams(void) {
}
...
// 0x80354240 | 624 bytes
void InteractorModule::FloorPainter::SetFloorTile(CTilePt &, FloorPattern, Room *, int *) {
}
...
// 0x8031CEF4 | 52 bytes
InteractorModule::GrabManipulator::GrabManipulatorParams::~GrabManipulatorParams(void) {
}
...
// 0x80359250 | 2404 bytes
void InteractorModule::InteractorInputManager::InstanceData::AddCommandMapping(InteractorModule::InteractorInputManager::InteractorCommand, int, int) {
}
...
// 0x80370A58 | 1292 bytes
InteractorModule::InteractorResourceSet::InteractorResourceSet(InteractorModule::InteractorResourceSet &) {
}
...
// 0x80369FD4 | 192 bytes
void InteractorModule::InteractorVisualizer::CreateResources(InteractorModule::WallPainter &) {
}

// 0x8036A094 | 32 bytes
void InteractorModule::InteractorVisualizer::DestroyResources(InteractorModule::WallPainter &) {
}

// 0x8036A0B4 | 92 bytes
void InteractorModule::InteractorVisualizer::PreDraw(InteractorModule::WallPainter &) {
}

// 0x8036A110 | 852 bytes
void InteractorModule::InteractorVisualizer::Draw(InteractorModule::WallPainter &) {
}
...
// 0x8036A938 | 468 bytes
void InteractorModule::InteractorVisualizer::CreateResources(InteractorModule::WallManipulator &) {
}
...
// 0x8036AFA4 | 32 bytes
void InteractorModule::InteractorVisualizer::DestroyResources(InteractorModule::WallManipulator &) {
}

// 0x8036AFC4 | 92 bytes
void InteractorModule::InteractorVisualizer::PreDraw(InteractorModule::WallManipulator &) {
}

// 0x8036B020 | 820 bytes
void InteractorModule::InteractorVisualizer::Draw(InteractorModule::WallManipulator &) {
}
...
// 0x8036C200 | 104 bytes
void InteractorModule::InteractorVisualizer::CreateResources(InteractorModule::ObjectManipulator &) {
}

// 0x8036C268 | 32 bytes
void InteractorModule::InteractorVisualizer::DestroyResources(InteractorModule::ObjectManipulator &) {
}

// 0x8036C288 | 92 bytes
void InteractorModule::InteractorVisualizer::PreDraw(InteractorModule::ObjectManipulator &) {
}

// 0x8036C2E4 | 400 bytes
void InteractorModule::InteractorVisualizer::Draw(InteractorModule::ObjectManipulator &) {
}

// 0x8036C474 | 144 bytes
void InteractorModule::InteractorVisualizer::CreateResources(InteractorModule::SimInteractor &) {
}

// 0x8036C504 | 32 bytes
void InteractorModule::InteractorVisualizer::DestroyResources(InteractorModule::SimInteractor &) {
}

// 0x8036C524 | 92 bytes
void InteractorModule::InteractorVisualizer::PreDraw(InteractorModule::SimInteractor &) {
}

// 0x8036C580 | 484 bytes
void InteractorModule::InteractorVisualizer::Draw(InteractorModule::SimInteractor &) {
}

// 0x8036C764 | 8 bytes
void InteractorModule::InteractorVisualizer::CreateResources(InteractorModule::DirectInteractor &) {
}

// 0x8036C76C | 8 bytes
void InteractorModule::InteractorVisualizer::DestroyResources(InteractorModule::DirectInteractor &) {
}

// 0x8036C774 | 92 bytes
void InteractorModule::InteractorVisualizer::PreDraw(InteractorModule::DirectInteractor &) {
}

// 0x8036C7D0 | 240 bytes
void InteractorModule::InteractorVisualizer::Draw(InteractorModule::DirectInteractor &) {
}

// 0x8036C8C0 | 8 bytes
void InteractorModule::InteractorVisualizer::CreateResources(InteractorModule::SocialModeInteractor &) {
}

// 0x8036C8C8 | 8 bytes
void InteractorModule::InteractorVisualizer::DestroyResources(InteractorModule::SocialModeInteractor &) {
}

// 0x8036C8D0 | 92 bytes
void InteractorModule::InteractorVisualizer::PreDraw(InteractorModule::SocialModeInteractor &) {
}
...
// 0x8036CCF0 | 1564 bytes
void InteractorModule::InteractorVisualizer::Draw(InteractorModule::PlacementObject &, EVec3 &) {
}
...
// 0x8031CF28 | 52 bytes
InteractorModule::PlaceManipulator::PlaceManipulatorParams::~PlaceManipulatorParams(void) {
}
...
// 0x8031CF90 | 52 bytes
InteractorModule::WallManipulator::WallManipulatorParams::~WallManipulatorParams(void) {
}
...
// 0x8031CFC4 | 52 bytes
InteractorModule::WallPainter::WallPainterParams::~WallPainterParams(void) {
}
...
// ======================================================================
// Additional InteractorModule stubs (gap fill)
// ======================================================================
