// 0x803B4E68 _List_base<ACTTarget::iqRecord *, allocator<ACTTarget::iqRecord *>>::clear (108B)
...
namespace ACTTarget { struct iqRecord; }

template void _List_base<ACTTarget::iqRecord *>::clear(void);
