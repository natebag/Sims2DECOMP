// 0x803A36A4 _List_base<SoundEventInfo, allocator<SoundEventInfo>>::clear (108B)
...
struct SoundEventInfo { int a, b, c; };

template void _List_base<SoundEventInfo>::clear(void);
