// 0x800EAA80 cXObjectImpl::IsRenderingRoot (60B) — MI vcall vt[728/732] XOR 1
...
struct SubBase : public SubNonVirtual {
    ...
    virtual int VcallAt91() = 0;  // slot 91, offset 728
};
...
int cXObjectImpl::IsRenderingRoot() {
    return m_sub->VcallAt91() ^ 1;
}
