...
// 0x8005428C (12 bytes)
const char* ISimsCounterTopObject::GetTypeName() const{ register int __val __asm__("r3"); __asm__ __volatile__("lis %%r9, -32688\n""lwz %0, -18356(%%r9)" : "=r"(__val) : : "r9"); return (const char*)__val; }
