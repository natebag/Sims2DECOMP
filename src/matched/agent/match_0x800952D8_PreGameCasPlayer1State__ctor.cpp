// 0x800952D8 PreGameCasPlayer1State::PreGameCasPlayer1State(int) (76B)
...
extern int __vt__22PreGameCasPlayer1State[];
...
struct PreGameCasPlayer1State {
    ...
    int m_28;
    int m_2C;
    PreGameCasPlayer1State(int x);
};

PreGameCasPlayer1State::PreGameCasPlayer1State(int x) {
    m_0 = x;
    m_C = -1;
    m_14 = 1;
    m_2C = 0;
    m_18 = __vt__22PreGameCasPlayer1State;
    m_4 = -1;
    m_8 = 0;
    m_10 = 0;
    m_1C = 0;
