// 0x80267228 __AI_DEBUG_set_stream_sample_rate(void) (32 B)
...
extern "C" void __AI_set_stream_sample_rate(unsigned int);
extern "C" void __AI_DEBUG_set_stream_sample_rate(unsigned int rate) { __AI_set_stream_sample_rate(rate); }
