// EEngine::ExitMovieMode(void)
// 0x802E2E8C | 60 bytes
// Calls _pResLoader->UnPauseLoads(), then EyeToyManager::ResumeStreams()
...
public:
    ...
    virtual void PauseLoads();
    virtual void UnPauseLoads();   // vtable entry 34 = offset 0x110
    virtual bool AreLoadsPaused();
};

void EyeToyManager_ResumeStreams();
...
void EEngine::ExitMovieMode() {
    _pResLoader->UnPauseLoads();
    EyeToyManager_ResumeStreams();
}
