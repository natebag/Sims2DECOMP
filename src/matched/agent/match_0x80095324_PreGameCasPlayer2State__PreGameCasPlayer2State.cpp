// 0x80095324 PreGameCasPlayer2State::PreGameCasPlayer2State(int) (76B)
...
extern int __vt__22PreGameCasPlayer2State[];

struct PreGameCasPlayer2State {
    int m_0;
    int m_4;
    int m_8;
    int m_C;
    ...
    int m_28;
    int m_2C;
    PreGameCasPlayer2State(int x);
};

PreGameCasPlayer2State::PreGameCasPlayer2State(int x) {
    m_0 = x;
    m_C = -1;
    m_14 = 1;
    m_2C = 0;
    m_18 = __vt__22PreGameCasPlayer2State;
    m_4 = -1;
    m_8 = 0;
    m_10 = 0;
    m_1C = 0;
