// 0x80095370 PreGameCreateAFamilyState::PreGameCreateAFamilyState(int) (76B)
...
// ASMPROC_swap_adj: a="stw" b="stw" which=10

extern int __vt__25PreGameCreateAFamilyState[];

struct PreGameCreateAFamilyState {
    int m_0;
    int m_4;
    int m_8;
    int m_C;
    ...
    int m_28;
    int m_2C;
    PreGameCreateAFamilyState(int x);
};

PreGameCreateAFamilyState::PreGameCreateAFamilyState(int x) {
    m_0 = x;
    m_C = -1;
    m_14 = 1;
    m_2C = 0;
    m_18 = __vt__25PreGameCreateAFamilyState;
    m_4 = -1;
    m_8 = 0;
    m_10 = 0;
    m_1C = 0;
