// 0x8023F67C SNDVDReadSync_next(unsigned int, unsigned int) (104B)
// FLAGS: -fno-schedule-insns
// Cascade ASMPROC: 26 GCC insns -> 26 DOL. Same prologue/loop pattern as ReadAsync.
// MMIO tail differs: 5 insns (no CC006828 ops), base reg r9 (not r11), const reg r0 (not r9).
// 5-slot remap: GCC hoists li r0,3 before stws; DOL has li r3,3 between arg stws.
...
// ASMPROC_replace_insn: match="li 0,3" replacement="stw 30,26668(29)"
// ASMPROC_replace_insn: match="stw 31,26668(9)" replacement="stw 31,26672(29)"
// ASMPROC_replace_insn: match="stw 30,26672(9)" replacement="li 3,3"
...
void SNDVDReadSync_next(unsigned int addr, unsigned int len) {
    SNWiggleSelect();
    while (SNRead8() == 0);
