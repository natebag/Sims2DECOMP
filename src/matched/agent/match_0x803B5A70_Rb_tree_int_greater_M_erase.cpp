// 0x803B5A70 _Rb_tree<int, pair<int, int>, greater<int>>::_M_erase (92B)
...
template <>
void _Rb_tree<int, pair<int, int>, _Select1st<pair<int, int> >, greater<int>, allocator<pair<int, int> > >::_M_erase(_Rb_tree_node<pair<int, int> >* __x) {
    while (__x != 0) {
