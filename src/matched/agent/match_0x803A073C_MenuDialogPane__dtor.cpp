...
void MenuDialogPane_parent_dtor(void* obj);
void __builtin_delete(void* p);
void __node_alloc_M_deallocate(void* p, unsigned int n);

struct MenuDialogPane {
    char pad_0_7[8];
    VecBase m_vec;
    char pad_14_5b[68];
    void* m_vt_at_5c;
...
void MenuDialogPane::dtor(int flag) {
    m_vt_at_5c = vt_MenuDialogPane;
    MenuDialogPane_parent_dtor(this);
    VecBase* vec = &m_vec;
    if (vec->m_start != 0) {
