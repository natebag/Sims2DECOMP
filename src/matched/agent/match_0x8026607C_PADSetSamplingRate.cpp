// 0x8026607C PADSetSamplingRate(void) (32 B)
...
extern "C" void SISetSamplingRate(unsigned int);
extern "C" void PADSetSamplingRate(unsigned int rate) { SISetSamplingRate(rate); }
