...
// 0x800D3D48 (16 bytes)
void NghResFile::GetID(Memory::HandleNode *, short *) { /* copy short via deref: 384(r3)->8->0(r5) */ }
...
// 0x800D3F78 (12 bytes)
void NghResFile::SetCurrentHouse(unsigned int) { *(int*)((char*)this + 0x24) = val + (-1); }
...
// 0x800D93C0 (12 bytes)
void* NghResFile::GetCurrentHouse() const { return (char*)(*(void**)((char*)this + 0x24)) + 0x1; }  // deref + offset
