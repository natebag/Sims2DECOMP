// 0x8000FF5C AptShaderWord::~AptShaderWord(void) (176B)

extern int AptWord_vt2[];
...
extern "C" void AptShaderWord_dtor(AptShaderWord* self, int in_charge) {
    char* s = (char*)self;
    void* f8 = *(void**)(s + 8);
    *(int**)(s + 44) = AptWord_vt2;
