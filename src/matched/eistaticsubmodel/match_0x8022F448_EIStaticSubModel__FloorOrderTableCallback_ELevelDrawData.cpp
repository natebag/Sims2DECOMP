// 0x8022F448 EIStaticSubModel::FloorOrderTableCallback(ELevelDrawData (196 B)
...
struct EIStaticSubModel {
    void FloorOrderTableCallback_ELevelDrawData();
};

void EIStaticSubModel::FloorOrderTableCallback_ELevelDrawData() {
}
