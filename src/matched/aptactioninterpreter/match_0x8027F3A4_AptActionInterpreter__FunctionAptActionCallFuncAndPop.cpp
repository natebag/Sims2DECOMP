// 0x8027F3A4 AptActionInterpreter::_FunctionAptActionCallFuncAndPop (160B)
// CallFunction then pop+MI-vcall with opcode 160 (vt+16/+20 dispatch).
// Twin template with CallMethodPop — identical except inner bl target.
...
struct AptActionInterpreter {
    ...
    static void _FunctionAptActionCallFunction(AptActionInterpreter* interp, LocalContextT* ctx);
    static void _FunctionAptActionCallFuncAndPop(AptActionInterpreter* interp, LocalContextT* ctx);
};

void AptActionInterpreter::_FunctionAptActionCallFuncAndPop(
