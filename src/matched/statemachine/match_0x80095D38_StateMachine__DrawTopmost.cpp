// StateMachine::DrawTopmost(ERC*) @ 0x80095D38 (64B)
struct ERC;
...
// Direct global at 0x80475C0C — outside SDA range, force non-SDA via array form
extern char g_topmostDrawEnabled[];
