...
// 0x801D9408 PRGTarget::GetUnlockedRecipies(void) (112B)
// Triple-vtable dispatch — final immediate = 0

typedef unsigned char u8;

extern u8* g_familyMgr2;

int PRGTarget_GetUnlockedRecipies(u8* self) {
    u8* mgr = g_familyMgr2;
    u8* vt1 = *(u8**)mgr;
