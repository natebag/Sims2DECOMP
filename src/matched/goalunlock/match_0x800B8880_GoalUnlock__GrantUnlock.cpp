// FLAGS: -fno-rtti
// 0x800B8880 (204B) GoalUnlock::GrantUnlock(IGoalUnlock::UnlockType, short)
...
void GoalUnlock::GrantUnlock(UnlockType type, short index) {
    int count;
    int firstVar;
    short s;
    int q;
    ...
    mask = 1 << r;
    ptr = (unsigned short*)(data + byteOffset);
    *ptr = *ptr | mask;
    SetRecentlyUnlocked(type, index, 1);
fail:
    return;
}
