// FLAGS: -fno-rtti
// 0x800B8B24 (208B) GoalUnlock::SetRecentlyUnlocked(IGoalUnlock::UnlockType, short, bool)
...
void GoalUnlock::SetRecentlyUnlocked(UnlockType type, short index, bool recent) {
    int count;
    int firstVar;
    short s;
    int q;
    ...
    if (recent) {
        ...
        short* data = (short*)m_unlockData;
        *(short*)((char*)data + byteOffset) |= mask;
    } else {
        int byteOffset = idx * 2;
        short* data = (short*)m_unlockData;
        *(short*)((char*)data + byteOffset) &= ~mask;
