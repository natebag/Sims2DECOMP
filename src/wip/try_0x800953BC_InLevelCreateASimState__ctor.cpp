// 0x800953BC InLevelCreateASimState::InLevelCreateASimState(int) (76B)
...
extern int __vt__22InLevelCreateASimState[];

struct InLevelCreateASimState {
    int m_0;
    int m_4;
    int m_8;
    int m_C;
    ...
    int m_28;
    int m_2C;
    InLevelCreateASimState(int x);
};

InLevelCreateASimState::InLevelCreateASimState(int x) {
    m_0 = x;
    m_C = -1;
    m_14 = 1;
    m_2C = 0;
    m_18 = __vt__22InLevelCreateASimState;
    m_4 = -1;
    m_8 = 0;
    m_10 = 0;
    m_1C = 0;
