...
//
//   0x04  NextFrame           -> _FunctionAptActionNextFrame (0x80272A44, 136B)
//   0x05  PrevFrame           -> _FunctionAptActionPrevFrame (0x80272ACC, 136B)
//   0x06  Play                -> _FunctionAptActionPlay (0x80272B54, 272B)
//   0x07  Stop                -> _FunctionAptActionStop (0x80272C64, 164B)
//   0x08  ToggleQuality       -> _FunctionAptActionToggleQuality (0x80272D08, 4B)
//         No-op (quality toggle not implemented on GC).
//
//   0x09  StopSounds          -> _FunctionAptActionStopSounds (0x80272D78, 36B)
//   0x0A  Add                 -> _FunctionAptActionAdd (0x80272D9C, 384B)
//         Pops two values, converts to float, pushes sum.
//
//   0x0B  Subtract            -> _FunctionAptActionSubtract (0x80272F1C, 384B)
//   0x0C  Multiply            -> _FunctionAptActionMultiply (0x8027309C, 384B)
//   0x0D  Divide              -> _FunctionAptActionDivide (0x8027321C, 292B)
//   0x0E  Equals              -> _FunctionAptActionEquals (0x80273340, 420B)
//   0x0F  LessThan            -> _FunctionAptActionLessThan (0x802734E4, 400B)
//   0x10  And                 -> _FunctionAptActionAnd (0x80273674, 440B)
//   0x11  Or                  -> _FunctionAptActionOr (0x8027382C, 448B)
//   0x12  Not                 -> _FunctionAptActionNot (0x80273FD0, 360B)
//         Pops value, converts to bool, pushes !result as boolean.
//
//   0x13  StringEquals        -> _FunctionAptActionStringEquals (0x80273A64, 468B)
//   0x14  StringLength        -> _FunctionAptActionStringLength (0x80273C38, 180B)
//   0x15  SubString           -> _FunctionAptActionSubString (0x80273CEC, 444B)
//   0x17  Pop                 -> _FunctionAptActionPop (0x802749BC, 164B)
//         Pops and releases top of stack value.
//
//   0x18  ToInteger           -> _FunctionAptActionToInteger (0x80274A60, 192B)
//   0x1C  GetVariable         -> _FunctionAptActionGetVariable (0x80274B20, 220B)
//   0x1D  SetVariable         -> _FunctionAptActionSetVariable (0x80274BFC, 252B)
//   0x20  SetTarget2          -> _FunctionAptActionSetTarget2 (0x80274CF8, 556B)
//   0x21  StringAdd           -> _FunctionAptActionStringAdd (0x80274F24, 268B)
//   0x22  GetProperty         -> _FunctionAptActionGetProperty (0x80275030, 288B)
//   0x23  SetProperty         -> _FunctionAptActionSetProperty (0x80275150, 264B)
//   0x24  CloneSprite         -> _FunctionAptActionCloneSprite (0x80275258, 188B)
//   0x25  RemoveSprite        -> _FunctionAptActionRemoveSprite (0x80275314, 236B)
//   0x26  Trace               -> _FunctionAptActionTrace (0x80275400, 388B)
//   0x27  StartDragMovie      -> _FunctionAptActionStartDragMovie (0x80275584, 912B)
//   0x28  StopDragMovie       -> _FunctionAptActionStopDragMovie (0x80275914, 168B)
//   0x29  StringLessThan      -> _FunctionAptActionStringLessThan (0x802759BC, 120B)
//         No-op stub.
//
//   0x2A  Throw               -> _FunctionAptActionThrow (0x8027BE58, 168B)
//   0x2B  CastOp              -> _FunctionAptActionCastOp (0x8027B570, 272B)
//   0x2C  ImplementsOp        -> _FunctionAptActionImplementsOp (0x8027B680, 1044B)
//   0x30  Random              -> _FunctionAptActionRandom (0x80275A34, 184B)
//   0x31  MBLength            -> _FunctionAptActionMBLength (0x80275AEC, 120B)
//   0x32  CharToAscii         -> _FunctionAptActionCharToAscii (0x80275B64, 120B)
//   0x33  AsciiToChar         -> _FunctionAptActionAsciiToChar (0x80275BDC, 232B)
//   0x34  GetTimer            -> _FunctionAptActionGetTimer (0x80275CC4, 84B)
//   0x35  MBSubString         -> _FunctionAptActionMBSubString (0x80275D18, 120B)
//   0x36  MBCharToAscii       -> _FunctionAptActionMBCharToAscii (0x80275D90, 120B)
//   0x37  MBAsciiToChar       -> _FunctionAptActionMBAsciiToChar (0x80275E08, 120B)
//   0x3A  Delete              -> _FunctionAptActionDelete (0x80275E80, 288B)
//   0x3B  Delete2             -> _FunctionAptActionDelete2 (0x80275FA0, 204B)
//   0x3C  DefineLocal         -> _FunctionAptActionDefineLocal (0x8027606C, 244B)
//   0x3D  CallFunction        -> _FunctionAptActionCallFunction (0x80276160, 708B)
//   0x3E  Return              -> _FunctionAptActionReturn (0x802769BC, 12B)
//         Sets ctx->m_returnFlag = 1. That's it. 3 instructions.
//
//   0x3F  Modulo              -> _FunctionAptActionModulo (0x8027645C, 300B)
//   0x40  NewObject           -> _FunctionAptActionNewObject (0x80276588, 356B)
//   0x41  DefineLocal2        -> _FunctionAptActionDefineLocal2 (0x802766EC, 308B)
//   0x42  InitArray           -> _FunctionAptActionInitArray (0x80276820, 308B)
//   0x43  InitObject          -> _FunctionAptActionInitObject (0x80276954, 504B)
//   0x44  TypeOf              -> _FunctionAptActionTypeOf (0x80276B4C, 924B)
//         Pops value, pushes string like "number", "string", "boolean",
//         "object", "movieclip", "function", "undefined".
//
//   0x45  TargetPath          -> _FunctionAptActionTargetPath (0x80276EE8, 352B)
//   0x46  Enumerate           -> _FunctionAptActionEnumerate (0x80277048, 84B)
//   0x47  Add2                -> _FunctionAptActionAdd2 (0x8027709C, 784B)
//         Smart add: string concat if either operand is string, else numeric.
//
//   0x48  LessThan2           -> _FunctionAptActionLessThan2 (0x802773AC, 608B)
//   0x49  Equals2             -> _FunctionAptActionEquals2 (0x8027760C, 2112B)
//         Complex equality with type coercion. Largest non-trivial opcode.
//
//   0x4A  ToNumber            -> _FunctionAptActionToNumber (0x80277E4C, 404B)
//   0x4B  ToString            -> _FunctionAptActionToString (0x80277FE0, 312B)
//   0x4C  PushDuplicate       -> _FunctionAptActionPushDuplicate (0x80278118, 92B)
//   0x4D  StackSwap           -> _FunctionAptActionStackSwap (0x80278174, 140B)
//   0x4E  GetMember           -> _FunctionAptActionGetMember (0x80278200, 524B)
//   0x4F  SetMember           -> _FunctionAptActionSetMember (0x8027840C, 772B)
//   0x50  Increment           -> _FunctionAptActionIncrement (0x80278710, 252B)
//   0x51  Decrement           -> _FunctionAptActionDecrement (0x8027880C, 252B)
//   0x52  CallMethod          -> _FunctionAptActionCallMethod (0x80278908, 2828B)
//   0x53  NewMethod           -> _FunctionAptActionNewMethod (0x80279414, 440B)
//   0x54  InstanceOf          -> _FunctionAptActionInstanceOf (0x8027B424, 332B)
//   0x55  Enumerate2          -> _FunctionAptActionEnumerate2 (0x802795CC, 84B)
//   0x60  BitAnd              -> _FunctionAptActionBitAnd (0x80279620, 260B)
//   0x61  BitOr               -> _FunctionAptActionBitOr (0x80279724, 260B)
//   0x62  BitXor              -> _FunctionAptActionBitXor (0x80279828, 260B)
//   0x63  BitLShift           -> _FunctionAptActionBitLShift (0x8027992C, 260B)
//   0x64  BitRShift           -> _FunctionAptActionBitRShift (0x80279A30, 260B)
//   0x65  BitURShift          -> _FunctionAptActionBitURShift (0x80279B34, 120B)
//   0x66  StrictEquals        -> _FunctionAptActionStrictEquals (0x80279BAC, 1024B)
//   0x67  Greater             -> _FunctionAptActionGreater (0x80279FAC, 520B)
//   0x69  Extends             -> _FunctionAptActionExtends (0x8027AED8, 832B)
//
// EXTENDED OPCODES (with data payload, opcodes >= 0x80):
//
//   0x81  GotoFrame           -> _FunctionAptActionGotoFrame (0x8027A1B4, 352B)
//   0x83  GetUrl              -> _FunctionAptActionGetUrl (0x8027A314, 660B)
//   0x87  StoreRegister       -> _FunctionAptActionStoreRegister (0x8027A5A8, 148B)
//   0x88  DefineDictionary    -> _FunctionAptActionDefineDictionary (0x8027A63C, 128B)
//   0x8B  SetTarget           -> _FunctionAptActionSetTarget (0x8027A6E8, 776B)
//   0x8C  GotoLabel           -> _FunctionAptActionGotoLabel (0x8027A9F0, 352B)
//   0x8E  DefineFunction2     -> _FunctionAptActionDefineFunction2 (0x8027B3D0, 352B)
//   0x8F  Try                 -> _FunctionAptActionTry (0x8027BB34, 964B)
//   0x94  With                -> _FunctionAptActionWith (0x8027AB50, 480B)
//   0x96  Push                -> _FunctionAptActionPush (0x8027AD30, 200B)
//   0x99  BranchAlways        -> _FunctionAptActionBranchAlways (0x8027EA50, 192B)
//   0x9A  GetUrl2             -> _FunctionAptActionGetUrl2 (0x8027ADF8, 1084B)
//   0x9B  DefineFunction      -> _FunctionAptActionDefineFunction (0x8027B234, 412B)
//   0x9D  BranchIfTrue        -> _FunctionAptActionBranchIfTrue (0x8027EB30, 240B)
//   0x9E  CallFrame           -> _FunctionAptActionCallFrame (0x8027EC20, 432B)
//   0x9F  GotoFrame2          -> _FunctionAptActionGotoFrame2 (0x8027EDD0, 640B)
//
// APT-SPECIFIC EXTENDED OPCODES (EA's extensions to SWF):
//
//   0xA3  PushString          -> _FunctionAptActionPushString (0x8027F110, 204B)
//   0xA4  PushStringDictByte  -> _FunctionAptActionPushStringDictByte (0x8027F1DC, 132B)
//   0xA5  PushStringDictWord  -> _FunctionAptActionPushStringDictWord (0x8027F260, 188B)
//   0xA6  PushStringGetVar    -> _FunctionAptActionPushStringGetVar (0x8027F31C, 232B)
//   0xA7  PushStringGetMember -> _FunctionAptActionPushStringGetMember (0x8027F404, 216B)
//   0xA8  PushStringSetVar    -> _FunctionAptActionPushStringSetVar (0x8027F4DC, 216B)
//   0xA9  PushStringSetMember -> _FunctionAptActionPushStringSetMember (0x8027F5B4, 216B)
//   0xAA  StringDictByteGetVar    -> _FunctionAptActionStringDictByteGetVar (0x8027F68C, 204B)
//   0xAB  StringDictByteGetMember -> _FunctionAptActionStringDictByteGetMember (0x8027F758, 144B)
//   0xAC  DictCallFuncPop         -> _FunctionAptActionDictCallFuncPop (0x8027F7E8, 200B)
//   0xAD  DictCallFuncSetVar      -> _FunctionAptActionDictCallFuncSetVar (0x8027F8B0, 204B)
//   0xAE  DictCallMethodPop       -> _FunctionAptActionDictCallMethodPop (0x8027F97C, 200B)
//   0xAF  DictCallMethodSetVar    -> _FunctionAptActionDictCallMethodSetVar (0x8027FA44, 204B)
//   0xB0  PushFloat           -> _FunctionAptActionPushFloat (0x8027FB10, 220B)
//   0xB1  PushByte            -> _FunctionAptActionPushByte (0x8027FBEC, 116B)
//   0xB2  PushWord            -> _FunctionAptActionPushWord (0x8027FC60, 172B)
//   0xB3  PushDWord           -> _FunctionAptActionPushDWord (0x8027FD0C, 220B)
//   0xB4  BranchIfFalse       -> _FunctionAptActionBranchIfFalse (0x8027FDE8, 240B)
//   0xB5  PushThisVariable    -> _FunctionAptActionPushThisVariable (0x8027FFE0, 132B)
//   0xB6  PushGlobalVariable  -> _FunctionAptActionPushGlobalVariable (0x80280064, 72B)
//   0xB7  PushZeroSetVar      -> _FunctionAptActionPushZeroSetVar (0x802800AC, 100B)
//   0xB8  PushThis            -> _FunctionAptActionPushThis (0x80280110, 116B)
//   0xB9  PushGlobal          -> _FunctionAptActionPushGlobal (0x80280184, 116B)
...
//
//   0xBC  PushTrue            -> _FunctionAptActionPushTrue (0x8027ECA0, 84B)
//   0xBD  PushFalse           -> _FunctionAptActionPushFalse (0x8027ECF4, 84B)
//   0xBE  PushNULL            -> _FunctionAptActionPushNULL (0x8027ED48, 72B)
//   0xBF  PushUndefined       -> _FunctionAptActionPushUndefined (0x8027ED90, 72B)
//   0xC0  CallFuncAndPop      -> _FunctionAptActionCallFuncAndPop (0x8027EDD8, 128B)
//   0xC1  CallFuncSetVar      -> _FunctionAptActionCallFuncSetVar (0x8027EE58, 132B)
//   0xC2  CallMethodPop       -> _FunctionAptActionCallMethodPop (0x8027EEDC, 128B)
//   0xC3  CallMethodSetVar    -> _FunctionAptActionCallMethodSetVar (0x8027EF5C, 132B)
