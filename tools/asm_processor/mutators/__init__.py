...
from . import force_reg, fp_relabel, gpr_relabel, nop_before, swap_adj  # noqa: E402 (registry below)

REGISTRY = {m.NAME: m for m in (swap_adj, force_reg, nop_before, fp_relabel, gpr_relabel)}
